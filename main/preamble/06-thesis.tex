...
% ----- Math macros ----------------------------------------------------------
% Indicator of a predicate, \ind{t < |\tau|}. Set as an upright bold one rather
% than \mathbb{1}: the AMS blackboard font msbm carries no digits, and pulling
% in bbm or dsfont for a single symbol would add a font to the document.

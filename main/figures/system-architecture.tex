...
%    framework, white = the system under test. The caption says so; do not add a
%    legend row.
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \node[font=\small] at ([yshift=-3.5mm]ez.north)
      {\code{efficientzero} --- the \gls{rl} agent};
  ...
  \caption[System architecture]{%
    ...
    \code{mugiwara} wraps each \gls{sut} into an environment as expected by \code{efficientzero}.

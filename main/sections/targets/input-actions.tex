...
As described in~\cref{sec:input-level-actions}, we model actions as actual SUT input
and a single environment step then consists of supplying a single byte to the SUT.
...
open62541 is an open-source OPC~UA implementation~\cite{open62541_open62541_nodate}.\index{target!open62541}

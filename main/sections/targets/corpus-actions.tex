...
libxml2 v2.15.3 is an XML parser commonly used in Linux~\cite{veillard_libxml2_nodate}.\index{target!libxml2}
...
picohttpparser is a header-only HTTP/1.x request parser~\cite{oku_picohttpparser_nodate}.\index{target!picohttpparser}

...
cJSON 1.7.19 is a single-file recursive-descent \gls{json} parser written in C.\index{target!cJSON}
...
libxml2 v2.15.3 is an XML parser commonly used in Linux.\index{target!libxml2}
...
picohttpparser is a header-only HTTP/1.x request parser.\index{target!picohttpparser}

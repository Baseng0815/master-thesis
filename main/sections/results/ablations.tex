...
%    this result. The campaign's SIMS50 and SIMS100 arms are the evidence in hand
%    (\cref{sec:target-cjson}); a one-simulation arm was not run, so either add it or
%    say explicitly that the search-width evidence stops at 50.
%

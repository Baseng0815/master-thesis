...
to the exact hit count and allows to represent a wider range of hit counts in
comparison with linear bucketing.
...
includes additional bonus coverage if the password was found.
...
than the union of all previous executions equally to an execution that reaches
exactly one level deeper than the best previous execution.

...
For a given SUT, we model the state space as the joint state of process memory,
kernel state, the register file and any other execution state needed to run the SUT.
This constitutes a full description of the SUT and therefore suffices to fully predict future
behavior of the SUT given new inputs.
...
true SUT state $\mathcal{S}_F$ to coverage feedback $\mathcal{C}$.

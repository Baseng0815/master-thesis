...
\subsection{Determinism and the Planning Contract}\label{sec:corpus-determinism}

% TODO: The central design subsection of the corpus formulation --- give it the space
% that implies.
%

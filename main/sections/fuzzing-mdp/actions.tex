...
One way to model actions is as actual SUT inputs.\index{action space!input-level}
This is a viable approach for SUTs that consume their inputs byte-by-byte.
The learned policy $\pi$ in this case represents a generative model for inputs
that conform to the SUT's grammar.

...
Directed exploration makes use of the \emph{upper confidence bounds}\index{upper confidence bound} rule to estimate which arms
...
This gives rise to the UCT rule\index{upper confidence bound!applied to trees}~\cite{hutchison_bandit_2006} that is used in an

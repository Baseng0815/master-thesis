...
correspondence\todo{cite: RedQueen (Aschermann et al.\ NDSS 2019)}.
...
AFL++ collects coverage feedback at edge granularity.
Hit counts are bucketed into buckets of power-of-two sizes as well as a fixed-size hashed coverage map.

...
Unicorn is a popular emulator based on QEMU~\cite{bellard_qemu_2005} and is
...
a given run limit.
The program \emph{yields} control back to the caller whenever it encounters a stopping

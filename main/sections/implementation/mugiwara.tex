...
$4096\times 8=32768$.
Two \code{Coverage}s can be merged by taking the per-bucket maximum.
This operation is useful when accumulating coverage information generated
successively by a sequence of mutated seeds, like in the corpus-level action
targets.
...
Building these targets is done via Dockerfiles and integrated into the default

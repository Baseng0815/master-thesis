...
The use of a prior entails a slight modification of the UCT rule, called pUCT (prior UCT).\index{upper confidence bound!prior (pUCT)}
...
The resulting observation-reward tuples $(o,u)$ are stored in a replay buffer,\index{replay buffer}

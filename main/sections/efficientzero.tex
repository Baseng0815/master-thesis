...
AlphaGo~\cite{silver_mastering_2016} was published in 2016 and was the first program to defeat a
...
repeated a fixed number of times: \emph{selection}, \emph{expansion}, and
\emph{backup}.
...
Prepared batches are then processed by reanalyze workers.
...
EfficientZero adds a SimSiam-inspired~\cite{chen_exploring_2020}
training signal.

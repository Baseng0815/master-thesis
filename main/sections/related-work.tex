...
For six of the seven papers that use a form of Q-learning or SARSA, we
...
\begin{description}[style=nextline, leftmargin=0pt, labelindent=0pt, labelwidth=0pt]
  ...
  \item[Fang and Yan (2018)~\cite{lopez_emulation-instrumented_2018}]
    LEFT (LTE-Oriented Emulation-Instrumented Fuzzing Testbed)\index{LEFT} is a fuzzer for the
...
\begin{itemize}
  ...
  \item \textbf{Coverage as the state model.}
    ...
    We propose to include coverage information in the observations that the RL agent receives.
  ...
  \item \textbf{Generic reward signal.}
    A big advantage of RL-based approaches is that they do not rely on binary decisions,

...
\begin{enumerate}[label=\textbf{RQ\arabic*.}, ref=RQ\arabic*, leftmargin=*]
  ...
  \item\label{ans:planning}
    ...
    This question can partially be answered with a \enquote{yes} as seen by the \gls{kl} divergence
...
is not clear.
While an \gls{rl}-based approach can make better use of information and works
for the small examples included in this thesis, the major advantage of
\gls{cgf}, the high execution throughput to test millions of seeds in a
short time, is hard to beat.

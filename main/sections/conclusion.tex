...
\begin{enumerate}[label=\textbf{RQ\arabic*.}, ref=RQ\arabic*, leftmargin=*]
  ...
  \item\label{ans:planning}
    ...
    This question can also be answered with a \enquote{yes} as seen by the KL divergence
...
The potential in our approach lies in learning regularity in SUT behavior and exploiting

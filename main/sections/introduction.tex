...
Reinforcement learning is a machine learning paradigm that aims to solve these
kinds of problems.
...
the use of model-based RL promises higher sample efficiency, requiring fewer

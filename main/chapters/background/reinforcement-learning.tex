...
Formally, a Markov decision process is a 3-tuple $MDP=(S,A,p)$ where
...
\begin{itemize}
  ...
  \item This is the central argument for choosing a model-based, planning-heavy algorithm over the
    model-free methods used by most prior RL fuzzers (\cref{chap:related-work}).
\end{itemize}
